...
<div style="position: absolute; z-index:210; right: 20px; top: 20px; display: none;">
	...
	<img class="logo animate s3" src="assets/img/netflix.png">
        	...
        	<div class="celula">
                    ...
                    <div class="flag">
                        <div class="perf tabela">
                            <div class="cont_foto celula">
                                <div class="foto" style="background-image: url(assets/img/personagens/pers_2.png)"></div>
                            </div>
                ...
                <div class="cont_flag cf_1 absolute100 index4">
                    <div class="flag">
                        <div class="perf tabela">
                            <div class="cont_foto celula">
                                <div class="foto" style="background-image: url(assets/img/personagens/pers_3.png)"></div>
                            </div>
                            <div class="titulo celula">
                                Shaolin Fantastic
                ...
                <div class="cont_flag cf_2 absolute100 index4">
                    <div class="flag">
                        <div class="perf tabela">
                            <div class="cont_foto celula">
                                <div class="foto" style="background-image: url(assets/img/personagens/pers_1.png)"></div>
                            </div>
                            <div class="titulo celula">
                                Crazy Eyes
                ...
                <div class="cont_flag cf_3 absolute100 index4">
                    <div class="flag">
                        <div class="perf tabela">
                            <div class="cont_foto celula">
                                <div class="foto" style="background-image: url(assets/img/personagens/pers_4.png)"></div>
                            </div>
                            <div class="titulo celula">
                                Dustin Henderson
                ...
                <div class="cont_flag cf_4 absolute100 index4">
                    <div class="flag">
                        <div class="perf tabela">
                            <div class="cont_foto celula">
                                <div class="foto" style="background-image: url(assets/img/personagens/pers_5.png)"></div>
                            </div>
                            <div class="titulo celula">
                                Lito Rodrigues
                ...
                <div class="cont_flag cf_5 absolute100 index4">
                    <div class="flag">
                        <div class="perf tabela">
                            <div class="cont_foto celula">
                                <div class="foto" style="background-image: url(assets/img/personagens/pers_6.png)"></div>
                            </div>
                            <div class="titulo celula">
                                Steven Murphy
                ...
                <div data-seta="1" data-inicio="0" class="seta_percurso seta_1"></div>
                <div data-seta="2" data-inicio="0" class="seta_percurso seta_2"></div>
                <div data-seta="3" data-inicio="5" class="seta_percurso seta_3"></div>
                <div data-seta="4" data-inicio="28" class="seta_percurso seta_4"></div>
                <div data-seta="5" data-inicio="90" class="seta_percurso seta_5"></div>
                <div data-seta="6" data-inicio="192" class="seta_percurso seta_6"></div>
                
                <div class="cont_svg" style="display:none">
                
                <img class="mapa" src="assets/img/mapa.png?ver=2" />
    ...
    <div class="detalhes">
        <div class="detalhe det_1 animate s2 scale mouseMove_1">
            <img id="detalhe-c1-1" src="assets/img/cloud-1-1.png" />
            <img id="detalhe-c1-2" src="assets/img/cloud-1-2.png" />
            <img id="detalhe-c1-3" src="assets/img/cloud-1-3.png" />
        </div>
        <div class="detalhe det_2 animate s2 scale mouseMove_2">
            <img src="assets/img/detalhe_2.png" />
        </div>
        <div class="detalhe det_3 animate s2 scale mouseMove_1">
            <img src="assets/img/detalhe_3.png" />
        </div>
        <div class="detalhe det_4 animate s2 scale mouseMove_2">
            <img id="detalhe-c2-1" src="assets/img/cloud-2-1.png" />
            <img id="detalhe-c2-2" src="assets/img/cloud-2-2.png" />
        </div>
    </div> 
	...
	<section>
    	...
    	<div class="cont_torce tabela escuro fixed100">
        	<div class="celula">
            	<a class="bt_fechar_torce" href="javascript:telas.fecha_torce()"><img class="bt_x animate" src="assets/img/bt_fechar_faq.png" /></a>
            	<div class="tabela cont_torcedor">
                    ...
                    <div class="linha">
                        ...
                        <div class="celula voto_ok">
                        	Parabéns!<br>Você é um ótimo torcedor,<br>continue a votar.
                        </div>
                    </div>
                    <div class="linha">
                    	<div class="celula" style="padding-top: 10px;">
                        	<a class="bt share fbGif" href="javascript:;">
                            ...
                            <a class="bt bt_shake mobile" href="javascript:telas.abre_shake();">
                            	<img src="assets/img/share_shake.png" width="45px;">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="tabela cont_shake mobile_table">
                	<a class="bt bt_shake" href="javascript:telas.fecha_shake();">
                		<img class="voltar_shake" src="assets/img/seta_left.png" />
                    </a>
                    
                	<div class="linha">
                    	<div class="celula shake_hand" style="height:150px; position: relative">
                        	<div class="cont_conta_pontos tabela">
                                <div class="celula">
                                +1
                                </div>
                            </div>
                        	<img src="assets/img/shake_hand.png" />
                        </div>
                    </div>
                    <div class="linha">
                    	<div class="celula tituloGIF">
    	...
    	<div class="cont_faq tabela escuro fixed100">
        	<div class="celula">
            	<a class="bt_fechar_faq" href="javascript:telas.fecha_faq()"><img class="bt_x aniamate s1" src="assets/img/bt_fechar_faq.png" /></a>
            	Seus personagens <br class="mobile">favoritos estão <br class="mobile">competindo pra <br>ver quem tem <br class="mobile">mais fãs. <br>Quanto mais <br class="mobile">você torce, <br class="mobile">mais rápido eles <br class="mobile">correm.
				<span>Pra quem você vai torcer?<br class="mobile"><br class="mobile"><br class="mobile"></span>
            </div>
        </div>
    	...
    	<div class="cont_faq_inicio animate_no_init fixed100">
            ...
            <div id="ghm" style="display:none">
                    ...
                    <div class="celula" style="margin-top: 6%; display:block">
                        <img class="logo_tela" src="assets/img/netflix.png">
                    </div>
              
                    <div class="celula" style="margin-top: 11%; display:block"> 
                    	Seus personagens <br class="mobile">favoritos estão <br class="mobile">competindo pra <br>ver quem tem <br class="mobile">mais fãs. <br>Quanto mais <br class="mobile">você torce, <br class="mobile">mais rápido eles <br class="mobile">correm.
						<span>Pra quem você vai torcer?</span>
                    </div>            
                       
                    <div class="celula" style="vertical-align:top; text-align: left; margin-top: 6%; display:block">
                        <a class="bt_fechar_faq_inicio" href="javascript:telas.fecha_faq_inicio()"><img src="assets/img/bt_fechar_faq_inicio.png" /></a>
                    </div>
	...
	<section>
        ...
        <a class="cont_bt_outros_part down" href="javascript:part.scrollUp();">
            <img src="assets/img/seta_down.png" class="bt_outros_part" />
        </a>
    ...
    <section>    
        <div class="cont_logo tabela fixed100 index8 animate s2 slide opacity" >
            ...
            <div class="celula" style="height: 100%;">
               ...
               <img src="assets/img/maratona.png" class="titulo" /><br>
               <img src="assets/img/de_gifs.png" class="logo_netflix" />
        ...
        <div class="tabela fixed100 index6 tbl_seta">
            <div class="celula">
            	<div class="cont_seta">
                   <img class="seta_sombra animate s2 opacity" src="assets/img/seta_sombra.png" />
                   <img class="animate s2 opacity rio" src="assets/img/rio.png" />
                   <img class="seta" />
    ...
    <footer>
    	<div class="tabela">
           ...
           <div class="celula" style="width: 30%;">
            	...
            	<a href="https://www.netflix.com/" target="_blank"><div class="cont_logo_bar"><img class="logo_bar" src="assets/img/netflix.png"></div></a>
            
            
            	<a class="bt_watch" href="https://www.netflix.com/" target="_blank">
    ...
    <a href="#" class="off" id="toggle-audio" onclick="return false;">
        <img class="on" src="assets/img/audio_on.png">
        <img class="off" src="assets/img/audio_off.png">
    </a>
...
?>
var tempo_total = 30;//518400;
</script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
<script type="text/javascript" src="assets/js/jquery.ios-shake.js"></script>
...
<script src="assets/js/percurso.js"></script>
...
<script type="text/javascript" src="assets/js/pxloader/PxLoader.js"></script>
<script type="text/javascript" src="assets/js/pxloader/PxLoaderImage.js"></script> 
<script src="assets/js/script.js?ver=0"></script>
<?php 
	error_reporting(0);
	session_start();
	...
	if(isset($_SESSION['status'])){
		if($_SESSION['status']){
			echo "<script> 
					setTimeout(function(){
						telas.abre_torce('" . $_SESSION["id_img"] . "','"  .  $_SESSION["pers"] . "',"  .  $_SESSION["id"] . "); 
						part.voto_ok();
					},1000);
				</script>"; 
			echo '<script> 
...
$.shake({
		...
		callback: function() {
			if(!voto){
				...
				$('.cont_conta_pontos .celula').text("+" + (++num_votos));
				
				$('.cont_conta_pontos')
				.css({'opacity':1,'transform':'scale(1)'});
				$('.shake_hand img').fadeOut();
...
<script type="text/javascript" src="assets/js/keepRatio.js"></script>
